...
NobleDevice.prototype.readTelemetryServices = function(callback) {
  this.readUInt32LECharacteristic(GENERIC_ACCESS_UUID, ESTIMOTE_TELEMETRY_SERVICE_UUID, callback);
};
